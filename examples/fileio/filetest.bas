...
REM Private ID$ : Call GetApplicationID (ID$) : Call CheckSW1SW2()
REM If ID$ <> "FILECARD" Then Print "Card FILECARD is required for this test" : Exit
REM ResetCard : Call CheckSW1SW2()
ChDrive "@"
Private F, S$
...
F= Open "Data1" : Call CheckFileError ("Error opening DATA1")
